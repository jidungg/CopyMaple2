...
#pragma region BUILD_ITEM
	...
	NLOHMANN_JSON_SERIALIZE_ENUM(BUILD_ITEM_TYPE, {
		...
		{BUILD_ITEM_TYPE::ETC, "ETC"},
		{BUILD_ITEM_TYPE::LAST, "LAST"}
		});

	enum class ETC_BUILD_ITEM_ID
	{
		MONSTER_SPAWNER = 1000,
		PLAYER_SPAWNER,
		PORTAL,
	};
	NLOHMANN_JSON_SERIALIZE_ENUM(ETC_BUILD_ITEM_ID, {
		{ETC_BUILD_ITEM_ID::MONSTER_SPAWNER, "MONSTER_SPAWNER"},
		{ETC_BUILD_ITEM_ID::PLAYER_SPAWNER, "PLAYER_SPAWNER"},
		{ETC_BUILD_ITEM_ID::PORTAL, "PORTAL"},
		});
#pragma endregion
#pragma region EQUIP
