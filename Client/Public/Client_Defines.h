...
#pragma region BUILD_ITEM
	...
	NLOHMANN_JSON_SERIALIZE_ENUM(BUILD_ITEM_ID, {
		...
		{BUILD_ITEM_ID::GRASS_2, "GRASS_2"},
		{BUILD_ITEM_ID::GRASS_3, "GRASS_3"},
		{BUILD_ITEM_ID::GRASS_4, "GRASS_4"},
		{BUILD_ITEM_ID::GRASS_5, "GRASS_5"},
		{BUILD_ITEM_ID::BRIGHT_GRASS_1, "BRIGHT_GRASS_1"},
		{BUILD_ITEM_ID::BRIGHT_GRASS_2, "BRIGHT_GRASS_2"},
		{BUILD_ITEM_ID::BRIGHT_GRASS_3, "BRIGHT_GRASS_3"},
		{BUILD_ITEM_ID::BRIGHT_GRASS_4, "BRIGHT_GRASS_4"},
		{BUILD_ITEM_ID::BRIGHT_GRASS_5, "BRIGHT_GRASS_5"},
		{BUILD_ITEM_ID::FLOWR_GRASS_1, "FLOWR_GRASS_1"},
		{BUILD_ITEM_ID::FLOWR_GRASS_2, "FLOWR_GRASS_2"},
		{BUILD_ITEM_ID::FLOWR_GRASS_3, "FLOWR_GRASS_3"},
		{BUILD_ITEM_ID::FLOWR_GRASS_4, "FLOWR_GRASS_4"},
		{BUILD_ITEM_ID::FLOWR_GRASS_5, "FLOWR_GRASS_5"},
		{BUILD_ITEM_ID::DARK_FLOWR_GRASS_1, "DARK_FLOWR_GRASS_1"},
		{BUILD_ITEM_ID::DARK_FLOWR_GRASS_2, "DARK_FLOWR_GRASS_2"},
		{BUILD_ITEM_ID::DARK_FLOWR_GRASS_3, "DARK_FLOWR_GRASS_3"},
		{BUILD_ITEM_ID::DARK_FLOWR_GRASS_4, "DARK_FLOWR_GRASS_4"},
		{BUILD_ITEM_ID::DARK_FLOWR_GRASS_5, "DARK_FLOWR_GRASS_5"},
